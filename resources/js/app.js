...
//proceso_prod
Vue.component('tenant-proceso_prod-index', require('./views/tenant/proceso_prod/index.vue'));
Vue.component('tenant-proceso_prod-form', require('./views/tenant/proceso_prod/form.vue'));
Vue.component('tenant-proceso_prod-import', require('./views/tenant/proceso_prod/import.vue'));
Vue.component('tenant-proceso_prod-tej', require('./views/tenant/proceso_prod/tej.vue'));
