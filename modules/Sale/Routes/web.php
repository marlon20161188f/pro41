    ...
    Route::domain($current_hostname->fqdn)->group(function () {
        Route::middleware(['auth', 'locked.tenant'])->group(function () {
            ...
            Route::prefix('proceso_prod')->group(function() {
                ...
                Route::get('import/{id?}', 'ProdController@import')->name('tenant.proceso_prod.import')->middleware(['redirect.level']);
                ...
                Route::get('download/{external_id}/{format?}', 'ProdController@download');
